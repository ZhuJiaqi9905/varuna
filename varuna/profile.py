...
class Profiler:
    ...
    def dry_run(self, dummy_inputs, from_cache):
        ...
        if self.local_rank == 0 and (not (from_cache and os.path.exists(f"/mnt/gpu-91/varuna/profile_rank_{self.rank}/_tmp_ord_mod") and os.path.exists(f"/mnt/gpu-91/varuna/profile_rank_{self.rank}/_tmp_inp_shapes"))):
            ...
            with open(f"/mnt/gpu-91/varuna/profile_rank_{self.rank}/_tmp_ord_mod",'wb') as f:
                pickle.dump(list(self.ordered_modules.keys()),f)
            with open(f"/mnt/gpu-91/varuna/profile_rank_{self.rank}/_tmp_inp_shapes",'wb') as f:
            ...
            with open(f"/mnt/gpu-91/varuna/profile_rank_{self.rank}/_tmp_ord_mod",'rb') as f:
            ...
            with open(f"/mnt/gpu-91/varuna/profile_rank_{self.rank}/_tmp_inp_shapes",'rb') as f:
