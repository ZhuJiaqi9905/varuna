...
class Profiler:
    ...
    def dry_run(self, dummy_inputs, from_cache):
        ...
        if self.local_rank == 0 and (not (from_cache and os.path.exists("/workspace/Megatron-LM-varuna/_tmp_ord_mod") and os.path.exists("/workspace/Megatron-LM-varuna/_tmp_inp_shapes"))):
