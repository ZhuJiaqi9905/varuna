...
class AutoConfig:
    ...
    def __init__(self, num_gpus, gpus_per_vm, batch_size, rank=-1,
                profile_folder='/mnt/varuna/profiles', gpu_memory_capacity=None, verbose=True, 
    ...
    def read_model_structure(self, verbose):
        ...
        with open(f"/mnt/varuna/profile_rank_{self.rank}/_tmp_shape_changes",'rb') as f:
    ...
    def get_microbatch_size(self, pp_size):
        ...
        max_micro_bs = min([len(profile) - 1 for profile in self.compute_profile]) // 2
